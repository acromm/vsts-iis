...
var ApplicationManager = (function () {
    ...
    ApplicationManager.prototype.add = function (options, server) {
    ...
    ApplicationManager.prototype.setAppPool = function (appName, appPoolName, server) {
    ...
    ApplicationManager.prototype.setWindowsAuthentication = function (appPath, enable, server) {
        vsts.debug("Setting the AppPool for app...");
        var toolRunner = AppCmd.createAppCmdToolRunner(server);
    ...
    ApplicationManager.prototype.setAnonymousAuthentication = function (appPath, enable, server) {
        vsts.debug("Setting the AppPool for app...");
        var toolRunner = AppCmd.createAppCmdToolRunner(server);
        toolRunner.arg('set config');
        toolRunner.arg('"' + appPath + '"');
    ...
    ApplicationManager.prototype.exists = function (name, server) {
